...
"font: 11pt \"Ubuntu\";")
        ...
        self.yes.clicked.connect(lambda : self.server_delete())
        self.no.clicked.connect(lambda : self.nox())
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", f"Server: ({hostx})"))
